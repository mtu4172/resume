  ...
  \resumeSubHeadingListStart
    % \resumeSubHeadingListStart
        ...
        \resumeSubheadingProject
          ...
          \resumeItemListStart
            \resumeItemExperience
              {Trained a mulitmodal machine learning model, combining audio and visual input to identify guitar chords.}
            \resumeItemExperience
              {Tracked hand positions using Mediapipe framework, using finger positions to classify chords in video modality.}
            \resumeItemExperience
              {}
          \resumeItemListEnd
        % \resumeSubheadingProject
