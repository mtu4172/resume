  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItemExperience
          {Wrote and implemented unit tests for PrSM guidance software into a CI/CD pipeline}
        \resumeItemListEnd
    \resumeSubheading
      {University of Florida}{Gainesville, FL}
    ...
    % \resumeSubHeadingListStart
        \resumeSubheadingProject
          ...
          \resumeItemListStart
            ...
            \resumeItemExperience
              {Designed user interface for login and game components}
            \resumeItemExperience
              {Collaborated with teammates using Git, planned sprints, and delegated issues.}
          \resumeItemListEnd
        \resumeSubheadingProject
...
\section{Skills}
  \resumeSubHeadingListStartSkillsAwards
    \resumeSubItemSkills{Languages}{(Proficient) C++, Python, Java, JavaScript/TypeScript, HTML/CSS, MATLAB, LaTeX; (Familiar) SQL, R, ARM Assembly, Ada}
    \resumeSubItemSkills{Tools}{Git, Jira, }
  \resumeSubHeadingListEnd
...
\section{Awards}
  \resumeSubHeadingListStartSkillsAwards
    ...
    \resumeSubItemSkills{Benacquisto Scholarship Recipient}
